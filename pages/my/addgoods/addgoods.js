...
Page({
	...
	bindMultiPickerColumnChange: function (e) {
		...
		console.log('sdfsdf', data.multiIndex[0], data.multiArray[0], this.data.multiArray[1][this.data.multiIndex[1]].id);
	},
		...
		app.request({
			...
			successFn: function (res) {
				...
				if (res.data.code == '1') {
					...
					console.log('ct==============' + JSON.stringify(_this.data.multiArray));
				}
			},
			successFailFn: function () {
			},
